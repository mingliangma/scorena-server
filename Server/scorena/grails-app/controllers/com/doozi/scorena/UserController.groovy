...
class UserController {
	...
	def createNewUser(){
		...
		def resp = userService.createUser(request.JSON.username, request.JSON.email, request.JSON.password, request.JSON.avatarCode ,request.JSON.gender, request.JSON.region)
