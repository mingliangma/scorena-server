...
public class GameDataInputXmlSoccer implements IGameDataInput {
	...
	public GameDataInputXmlSoccer() 
	{
		...
		initializeGameDataInputForXmlSoccer(GameDataConstantsXmlSoccer.defaultApiUrl, 
				...
				GameDataConstantsXmlSoccer.defaultLeagueName, GameDataConstantsXmlSoccer.defaultSessionDate, 
				GameDataConstantsXmlSoccer.defaultQueryString, GameDataConstantsXmlSoccer.defaultHost, 
				GameDataConstantsXmlSoccer.defaultApiType, GameDataConstantsXmlSoccer.gameType_Soccer);
	}
	...
	public void initializeGameDataInputForXmlSoccer(String apiUrl, String apiMethod, String apiKeyValue, 
			String leagueName, String seasonDate, String queryString, String host, String apiType, String gameType)
	{	
		_apiUrl = apiUrl;
